...
<body>
    <!-- products start -->
<div class="main-content row mt-5 pt-3" >
            ...
            <nav class="navbar bg-transparent ">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item  active">
                        <a href="#" class="nav-link ms-lg-1 fw-bold" data-bs-toggle="dropdown"><i class="fa fa-list ms-lg-1 me-lg-2 ms-2 me-2 bg-white text-dark p-2 border rounded-circle"></i>Categories</a>
