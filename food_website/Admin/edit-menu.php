<?php
    ...
    if(isset($_GET['action'])&&$_GET['action']=='edit') {
        $p_id = $_GET['p_id'];
        $query = "select * from food where food_id = '$p_id'";
                ...
                <div class="p-3 page-content">
                    <div class="tab-content">
                        <ul class="nav nav-tabs nav-justified border-dark">
                            ...
                            <li class="nav-item"><a class="nav-link active" aria-current="page" href="edit-menu.php"><span><i class="fa-solid fa-pen-to-square"></i></span> Edit Menu</a></li>
                        </ul>
                    </div>
                    <div class="card m-3">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-6 col-sm-8 bg-secondary-subtle p-4 border border-dark border-1 rounded">
                            <form class="p-2" method="post" enctype="multipart/form-data">
                                <h3 class="text-center fw-bold">Edit Menu Form</h3>
                                <div class="form-group my-3">
                                    <label for="">Food Name</label>
                                    <input type="text" name="product_name" class="form-control" value="<?php echo $food_name ?>">
                                </div>
                                <div class="form-group my-3">
                                ...
                                <div class="form-group my-3">
                                    ...
                                    <input type="text" name="price" value="<?php echo $food_price; ?>" class="form-control">
                                </div>
                                
                                <div class="form-group my-3">
                                    <label for="">File input</label>
                                    <input type="file" name="photo" value="<?php echo $photo ?>">
                                    <img src="../images/<?php echo $photo ?>" width="120" height = "80">
                                </div>
                                <button type="submit" name="update_product" class="btn btn-dark submit-btn mt-3 form-control rounded-pill">Submit</button>
                            </form>
                        </div>    
                        <div class="col-lg-3 col-sm-2"></div>             
                    </div>
